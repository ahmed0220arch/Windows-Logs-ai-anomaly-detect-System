...
1..5 | ForEach-Object { 
    eventcreate /t ERROR /id 7031 /l system /d "The Print Spooler service terminated unexpectedly. It has done this 1 time(s). The following corrective action will be taken in 60000 milliseconds: Restart the service." | Out-Null
...
1..10 | ForEach-Object { 
    eventcreate /t ERROR /id 3000 /l application /d "FATAL: Massive SQL Injection pattern detected in incoming HTTP request to backend database." | Out-Null
